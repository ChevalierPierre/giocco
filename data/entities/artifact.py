...
class Artifact(pg.sprite.Sprite):
    ...
    def __init__(self, location, color, type):
        ...
        artifact_list = ["speed", "life", "clear"]
        self.artifact_mask = tools.Image.load(os.path.join("artifacts", random.choice(artifact_list) + ".png")).convert_alpha()
    ...
    def make_frame_dict(self):
        frames = tools.split_sheet(self.artifact_mask, (50, 50), 3, 1)[0]
