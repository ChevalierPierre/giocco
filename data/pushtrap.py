...
class Pushtrap(pg.sprite.Sprite):
    ...
    def __init__(self, location, direction, color):
        ...
        if direction == "front":
            self.pushtrap_mask = tools.Image.load(os.path.join("traps", "Push_Trap_Front.png")).convert_alpha()
            ...
            self.pushtrap_mask = tools.Image.load(os.path.join("traps", "Push_Trap_Left.png")).convert_alpha()
        ...
        self.pushtrap_frames = self.make_frame_dict()
